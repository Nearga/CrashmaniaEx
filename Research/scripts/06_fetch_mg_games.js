  ...
  res.on('end', () => {
    ...
    if (res.statusCode === 200) {
      try {
        ...
        fs.writeFileSync('/Users/vitaliivasylenko/Development/Unity/CrashmaniaEx/Research/mg_games.json', JSON.stringify(json, null, 2));
        console.log('Saved mg_games.json');
        ...
        if (game1002) {
            ...
            console.log('Game 1002 not found in mg games');
        }
      } catch(e) {
